    ...
    <div className="max-w-3xl mx-auto space-y-8 px-4 py-8">
      {blocks.map((block, index) => {
        switch (block.type) {
          case "title":
            return (
              <h1 key={index} className="text-4xl font-bold text-center mb-12">
          ...
          case "psalm":
            return (
              <h2 key={index} className="text-2xl font-semibold text-center mt-12 mb-6">
                <AnnotatedText text={block.content} annotations={block.annotations} />
              </h2>
            );
          ...
          case "heading":
            return (
              <h3 key={index} className="text-xl font-semibold mt-10 mb-4 text-primary">
                <AnnotatedText text={block.content} annotations={block.annotations} />
              </h3>
            );
          ...
          case "instruction":
            return (
              <p key={index} className="italic text-muted-foreground text-sm leading-relaxed mb-6">
                <AnnotatedText text={block.content} annotations={block.annotations} />
              </p>
            );
          ...
          case "response":
            return (
              <p key={index} className="text-sm text-muted-foreground italic pl-8 my-3">
                <AnnotatedText text={block.content} annotations={block.annotations} />
              </p>
            );
