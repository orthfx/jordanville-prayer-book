...
const annotationRules: Array<{
  ...
  },
  {
    ...
    annotation: {
      type: "glossary",
      definition:
        "The Trisagion (Thrice-Holy) prayer, one of the most ancient prayers in Orthodox worship.",
    },
  },
  {
    ...
    annotation: {
      type: "saint",
      definition:
        "One of the three Cappadocian Fathers (329-379 AD). Bishop, theologian, and monastic founder.",
  ...
  },
  {
    ...
    annotation: {
      type: "scripture",
      definition:
        "The Lord's Prayer, taught by Jesus Christ to His disciples (Matthew 6:9-13, Luke 11:2-4).",
  ...
  },
  {
    ...
    annotation: {
      type: "scripture",
      definition:
        "From the parable of the Pharisee and the Publican (Luke 18:9-14), a model of humble repentance.",
  ...
  },
  {
    ...
    annotation: {
      type: "glossary",
      definition:
        "A title for the Holy Spirit, the third Person of the Holy Trinity, invoked as the Comforter.",
    },
  },
  {
    pattern: /Troparia/gi,
    annotation: {
      type: "glossary",
      definition:
        "Short hymns or verses sung or recited in Orthodox services. Plural of troparion.",
    },
  },
];
